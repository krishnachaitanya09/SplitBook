...
namespace SplitBook
{
    ...
    sealed partial class App : Application
    {
        ...
        public Expense ADD_EXPENSE
        {
            get;
            set;
        }

        public Expense SELECTED_EXPENSE
        {
            get;
            set;
        }
        ...
        public App()
        {
            Microsoft.HockeyApp.HockeyClient.Current.Configure("fb96ef4556074ddf938c1ddda49d6ec5");
        ...
        {
            GoogleAnalytics.EasyTracker.GetTracker().SendException(e.Message + ":" + e.Exception.StackTrace + "::" + e.Exception.Data + "::" + e.Exception.Source + "::" + e.Exception.InnerException, true);
        }
